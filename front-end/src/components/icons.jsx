...
export function IconBrandApple(props) {
  return (
    <Icon {...props}>
...
export function IconBrandGithub(props) {
  return (
...
export function IconBrandGoogle(props) {
  return (
    <Icon {...props}>
...
export function IconBrandInstagram(props) {
  return (
    <Icon {...props}>
...
export function IconBrandPaypal(props) {
  return (
    <Icon {...props}>
...
export function IconBrandReddit(props) {
  return (
    <Icon {...props}>
...
export function IconBrandTypescript(props) {
  return (
    <Icon {...props}>
...
export function IconBrandVercel(props) {
  return (
    <Icon {...props}>
...
export function IconBrandYoutube(props) {
  return (
    <Icon {...props}>
...
export function IconCircleHelp(props) {
  return (
    <Icon {...props}>
...
export function IconCircleOff(props) {
  return (
    <Icon {...props}>
...
export function IconReplyAll(props) {
  return (
    <Icon {...props}>
...
export function IconSidebarOpen(props) {
  return (
    <Icon {...props}>
      <path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" />
      <path d="M9 4v16" />
...
export function IconUpdates(props) {
  return (
    <Icon {...props}>
